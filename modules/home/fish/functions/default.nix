let
  ...
  #   Aside from `programs.fish.functions.<name>.body`, `functions` submodule attrs correspond to long names of fish `function` command options.
  #
  #   See `man function` or [fishshell.com/docs/current/cmds/function.html](https://fishshell.com/docs/current/cmds/function.html).
  #
